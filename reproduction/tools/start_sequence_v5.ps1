...
$jobDirectory = Join-Path $paperDirectory 'experiments\sequence-v5'
...
$arguments = $prefix + '-- python3 -u "' + $wslPaper + '/tools/run_sequence_v5.py" run'
...
Write-Host "Monitor: & '$PSScriptRoot\monitor_sequence_v5.ps1' -Watch"
